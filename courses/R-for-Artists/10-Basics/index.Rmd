...
subtitle: "Where does Data come from? Why do we visualize it?"
...
{{< video https://www.youtube.com/embed/hZxnzfnt5v8 >}}
...
| #1        | #2        |                    |                       |
+===========+===========+:==================:+=======================+
| Position  | Position  | Points/Circles     | [![Scatter            |
| X = Quant | Y = Quant | with Fixed Size    | Plot](                |
| Variable  | Variable  |                    | https://img.icons8.co |
|           |           |                    | m/ios-filled/100/0000 |
|           |           |                    | 00/scatter-plot.png)] |
|           |           |                    | (https://img.icons8.c |
|           |           |                    | om/ios-filled/100/000 |
|           |           |                    | 000/scatter-plot.png) |
+-----------+-----------+--------------------+-----------------------+
