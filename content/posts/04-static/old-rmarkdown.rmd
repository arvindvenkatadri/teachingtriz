...
This is an example from `reactable` documentation - showing the Twitter
followers of some politicians.

[Example adapted from `{reactable}`
documentation](https://glin.github.io/reactable/articles/building-twitter-followers.html)
