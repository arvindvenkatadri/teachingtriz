...
`r newthought('In his later books')`[^2], Tufte starts each section with
...
Pandoc should at least 2.11 or `pandoc-citeproc` should be available and
at least 0.7.2. You can always install your own version of Pandoc from
https://pandoc.org/installing.html if the version is not sufficient. To
...
[^5]: The actual Envisioned CSS was not used in the **tufte** package.
