...
# We will use "fira" font in all graphs by default since other fonts throw errors. 
...
grey_nodes <- read_csv("../../../materials/data/grey_nodes.csv")
...
starwars_edges <- read_csv("../../../materials/data/star-wars-network-edges.csv")
...
```{r, message=FALSE}
airline_nodes <- read_csv("../../../materials/data/AIRLINES-NODES.csv") %>% mutate(Id = Id + 1)
...
GoT <- read_rds("../../../materials/data/GoT.RDS")
