...
+------------+------------+------------+------------+------------+
| Pronoun    | Answer     | Variable / | E xample   | What       |
|            |            | Scale      |            | O          |
|            |            |            |            | perations? |
+============+============+============+============+============+
...
| Sort       | Type or A  | /          |     onomic | ercentiles |
|            | ttribute   | O          |            |            |
|            | from a     | rdinal\*\* | status     |            |
|            | list, with |            |            |            |
|            | list items |            | ("low      |            |
|            | in some "  |            |            |            |
|            | or         |            |     i      |            |
...
|            |            |            |     ike"). |            |
+------------+------------+------------+------------+------------+
| How Many / | Q          | Qu         | -   pH     | -   Mean   |
| Much /     | uantities  | antitative |            |            |
| Heavy?     | with       | / Interval | -   SAT    | -          |
| Few?       | Scale.     |            |            |   Standard |
| Seldom?    |            |            |     score  |            |
| Often?     | **D iff e  |            |     ( 20   |  Deviation |
| When?      | rences**   |            |     0-800) |            |
|            | are me a   |            |            |            |
|            | ningful,   |            | -   Credit |            |
|            | but not    |            |            |            |
...
| Heavy?     | with Scale | Ratio\*\*  |            | rre        |
| Few?       | and a Zero |            |     L      | lation -   |
| Seldom?    | Value.     |            |     ength, | Coeff of   |
| Often?     |            |            |            |            |
| When?      | Di f       |            | Height     | V ariation |
|            | ferences   |            |            |            |
|            | and Ratios |            | -   Te     |            |
|            | / Products |            |            |            |
|            | are me a   |            | m pe       |            |
