...
+-------------+-------------+-------------+-------------+-------------+
| Pronoun     | Answer      | Variable /  | E xample    | What O      |
|             |             | Scale       |             | perations?  |
+=============+=============+=============+=============+=============+
| What, Who,  | Name,       | Q           | Name        | -   Count   |
| Where,      | Place,      | ualitative  |             |     no. of  |
| Whom, Which | Animal,     | / N         |             |     cases   |
|             | Thing       | ominal\*\*  |             |             |
|             |             |             |             | -   Mode    |
+-------------+-------------+-------------+-------------+-------------+
| How, What   | A Manner /  | Q           | -   So      | -   Median  |
| Kind, What  | Method,     | ualitative  |     cio-ec  | -   P       |
| Sort        | Type or A   | / O         |     onomic  |             |
|             | ttribute    | rdinal\*\*  |             |  ercentiles |
|             | from a      |             | status      |             |
|             | list, with  |             |             |             |
|             | list items  |             | ("low       |             |
|             | in some "   |             |             |             |
...
| Heavy? Few? |             | / Interval  | -   SAT     | -           |
| Seldom?     | **D iff e   |             |             |    Standard |
| Often?      | rences**    |             |     score ( |             |
| When?       | are me a    |             |     20      |             |
|             | ningful,    |             |     0-800)  |   Deviation |
|             | but not     |             |             |             |
|             | products or |             | -   Credit  |             |
|             | ratios      |             |             |             |
|             |             |             |     score   |             |
...
| Heavy? Few? | with Scale  | Ratio\*\*   |             | rre         |
| Seldom?     | and a Zero  |             |     L       | lation -    |
| Often?      | Value.      |             |     ength,  | Coeff of    |
| When?       |             |             |             |             |
|             | Di f        |             | Height      | V ariation  |
|             | ferences    |             |             |             |
|             | and Ratios  |             | -   Te      |             |
|             | / Products  |             |             |             |
|             | are me a    |             | m pe rature |             |
|             | ningful.    |             | in          |             |
|             | (e.g Weight |             |             |             |
|             | )           |             | Kelvin      |             |
|             |             |             |             |             |
