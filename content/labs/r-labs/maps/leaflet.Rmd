...
say OSM data\<https://osm. Let us get hold of restaurants data in
...
fontawesome icons simply do not seem to show up. ;-()
...
We have `r nrow(colleges)` colleges in our data and `r nrow(parks)`
parks in our data.
