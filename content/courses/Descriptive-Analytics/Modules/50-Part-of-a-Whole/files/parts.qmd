...
I have downloaded this data from Our World in Data:
...
This is a simple pre-aggregated dataset, with one categorical column and
one numerical column, perfectly suited to plotting Pies and Fans. We
will use this variable to plot a Pie chart and the much better Fan
chart.
...
Clearly this is messy...we will take the top 8 industries by emission
and `lump` the rest into an `other` category:
