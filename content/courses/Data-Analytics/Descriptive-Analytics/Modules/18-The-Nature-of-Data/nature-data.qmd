...
| Qual Variable    | Count of Qual    |                  |
|                  | Variable         |                  |
+------------------+------------------+------------------+
| Position X =     | Position Y =     | Rectangles, with |
| Qual Variable    | Qual Variable    | *area*           |
|                  |                  | proportional to  |
|                  |                  | joint(X,Y)       |
|                  |                  | *count*          |
+------------------+------------------+------------------+
| Position X =     | Position Y =     | Box + Whisker,   |
| Qual Variable    | Rank-Ordered     | Box length       |
