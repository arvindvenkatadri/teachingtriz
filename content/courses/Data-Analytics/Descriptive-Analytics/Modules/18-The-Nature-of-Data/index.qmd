...
| Where,      | Place,      | litative or |             |     of      |
| Whom, Which | Animal,     | No m        |             |             |
|             | Thing       | inal\*\*    |             |     Cases   |
|             |             |             |             |             |
|             |             |             |             | -   Mode    |
+-------------+-------------+-------------+-------------+-------------+
| How, What   | A Manner /  | Q u a       | So c i o    | -   Median  |
| Kind, What  | Method /    | litative or | economic    |             |
| Sort        | Type or A   | Or d        | status,     | -   P e r   |
|             | ttribute    | inal\*\*    |             |             |
|             | from a      |             | E d         | centiles    |
|             | List, with  |             | ucation,    |             |
|             | list items  |             |             |             |
...
| How much,   | antities    | titative or |             |             |
| How Heavy , | with Scale  | I n t e     | SAT Score ( | -           |
| How few,    |             | rval\*\*    | 200-800)    |    Standard |
| Seldom,     | **Di f f e  |             |             |             |
| Often, When | rences**    |             | Credit      | D eviation  |
|             | are m e a   |             | Score (     |             |
|             | ningful,    |             | 300-850)    |             |
|             | but not     |             |             |             |
|             | products or |             | Year of     |             |
...
| How much,   | ntities,    | titative or | Length,     | relation    |
| How Heavy , | with Scale  | Ratio\*\*   | Height,     |             |
| How few,    | and a Zero  |             |             | C o e       |
| Seldom,     | Value.      |             | T e m p     | fficient of |
| Often, When |             |             | erature,    | V ariation  |
|             | D i f       |             | Enzyme A    |             |
|             | ferences    |             | ctivity,    |             |
|             | and Ratios  |             | Dosage      |             |
|             | / Products  |             | Amount,     |             |
