...
|     |     | <a href="~/content/slides/analy                                                               
             tics-slides/Nature-of-Data.txt"> \< iconify-icon icon="icon-park:ppt"\>\< /iconify-icon\></a>  |     |
|-----|-----|-----------------------------------------------------------------------------------------------|-----|
|     |     |                                                                                               |     |
...
+======================+======================+======================+
| Position X = Quant   | Position Y = Quant   | P oints/Circles with |
