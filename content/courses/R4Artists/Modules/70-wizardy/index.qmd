...
(currently) is to use the `showtext` package (which we loaded above) to bring into our work fonts from Google. To view and select the fonts you might want to work with, spend some time looking over:
...
![Rosana Ferrero (\@RosanaFerrero) on Twitter Sept 11, 2022](images/ggplot_theme_elements.jfif){fig-alt="Ggplot theme elements"
fig-align="center"}
