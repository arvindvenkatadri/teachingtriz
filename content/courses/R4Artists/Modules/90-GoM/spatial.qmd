...
| <a href="../../labs/r-labs/maps/gram-maps.qmd"><i class="fa-brands                        
                                fa-r-project"></i> R Tutorial</a>                           | <a href="../../../slides/r-slides/spatial/index.qmd"><iconify-icon icon="icon-park:ppt"></iconify-icon> Slides </a> |     |     |
|----------------|------------------------|----------------|----------------|
