...
- `data` represents the data vector - `start` represents the first observation in time series\
...
*quantitative* columns are the individual series. Let us plot the
timeseries:
...
`Date` column as $92$. [Run `mosaic::inspect(prison)` in your Console]{.aside}.
