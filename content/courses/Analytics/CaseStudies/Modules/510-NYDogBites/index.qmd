---
title: <iconify-icon icon="iconoir:sea-waves"></iconify-icon> <iconify-icon icon="mdi:weed"></iconify-icon>  New York Dog Bites
order: 510
---
...
seaweed_bump %>%
  ...
  scale_x_discrete(labels = 
                     c("Calcium", "Carbs", "Fibre", "Potassium", "Zinc"), guide = "prism_bracket") +
  geom_point(size = 3, fill = "black") +
  scale_shape_manual("Seaweed Type", 
                     values = c(0, 1, 2, 5, 7, 8, 15, 16, 18)) +
  scale_colour_discrete("Seaweed Type") +
  scale_y_reverse(breaks = c(1:9)) +
  scale_linetype_manual("Seaweed Type", 
                        values = c(1, 2, 3, 4, 5, 6, 1, 2, 3)) +
