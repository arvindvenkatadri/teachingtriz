...
coloured lines would be in the same place as the black line]{style="background-color: yellow;"}. It should be clear that if $\mu_A$ and $\mu_B$ are different from the overall mean $\mu_{tot}$, then $SSE < SST$.
...
significantly different by analyzing (a ratio of) variances!]{style="background-color: yellow;"} Hence
...
6.  Judd, Charles M., Gary H. McClelland, and Carey S. Ryan. 2017.
    "Introduction to Data Analysis." In, 1--9. Routledge.
    https://doi.org/10.4324/9781315744131-1.

7.  Patil, I. (2021). *Visualizations with statistical details: The
