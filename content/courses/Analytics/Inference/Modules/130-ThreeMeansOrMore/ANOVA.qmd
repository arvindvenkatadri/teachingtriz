...
data, so all Time readings are in one numerical column, all Temperatures
are also in a column that we should convert into a `factor`:
...
*degrees of freedom*, which gives us [a ratio of
**variances**:]{.underline}
