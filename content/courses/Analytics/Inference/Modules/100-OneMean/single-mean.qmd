...
when the number of observations $n >=50$. Lindoloev has a [simulation on
...
OpenIntro Modern Statistics, [Chapter #17](https://openintro-ims.netlify.app/inference-one-prop.html)
...
cite_packages(
  ...
  out.dir = ".",
  out.format = "html",
  pkgs = c("resampledata", "openintro", "infer", "TeachHist",
           "TeachingDemos")
) %>%
