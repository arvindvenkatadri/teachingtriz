...
|                                                                                        |                                                                                                                     |                                                                                               |                                                                                        |
|-----------------|---------------------|-----------------|-----------------|
| <a href="./files/sampling.qmd"><i class="fa-brands fa-r-project"></i> R Tutorial</a>   | <a href="./files/sampling.ows"> <iconify-icon icon="fluent-emoji:orange-circle"></iconify-icon> Orange Tutorial</a> | <a href="./files/sampling.rda"> <i class="fa-solid fa-person-rays"></i> Radiant Tutorial</a>  | <a href="./files/data/qdd-data.zip"> <i class="fa-solid fa-database"></i> Datasets</a> |
...
-   This is [regardless of the distribution of the *population*
    parameter]{style="background-color: yellow;"} itself.
:::

The `Height` variable seems to be normally distributed at population
level. We will try other non-normal population variables as an exercise
in the tutorials.
