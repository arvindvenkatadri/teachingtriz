...
**the direction of cause (polarity)** and **effect (magnitude)** correct in your models. 
...
::: callout-note
But for a model used for classification or prediction, it may be unnecessary to represent causation correctly. Instead, other issues, e.g., the
...
science, medicine, government, and commerce -- is **how you can legitimately draw conclusions about interventions from models based on data collected without performing these interventions.**
:::
