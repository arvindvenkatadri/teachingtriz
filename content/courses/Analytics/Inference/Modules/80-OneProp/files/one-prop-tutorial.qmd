...
Let us see if the incidence of recidivism is dependent upon whether a
...
"No". We ought to convert it to a numeric variable of 1's and 0's. Why?
...
Let us compute the proportion of times that each carrier's flights was
delayed more than 20 min. We will conduct a two-sided test to see if the
...
[^1]: https://github.com/rudeboybert/resampledata
