...
data %>% select(evaluator, candidate_selected) %>% as_tibble()
...
#| echo: false
#| warning: false
obs_difference <- diff(mean(candidate_selected ~ evaluator, data = data))
obs_difference
...
p0 <- data %>% 
 ...
 expand_limits(y = c(0,28)) +
  ...
  ggbrace::stat_brace(aes(#x = c(4.5, 5.5, 4.5, 5.5), 
                          # What a hack this is!!
                          #y = c(4, 24, 5, 24),
                      label = evaluator),
...
## {{< iconify pajamas issue-type-test-case >}}  Case Study #2: Weight vs Exercise in the YRBSS Survey
...
\
 Mine Çetinkaya-Rundel and Johanna Hardin,[OpenIntro Modern Statistics: Chapter 17](https://openintro-ims.netlify.app/inference-one-prop.html)\
Laura M. Chihara, Tim C. Hesterberg, [*Mathematical Statistics with Resampling and R*. 3 August 2018.© 2019 John Wiley & Sons, Inc.](https://onlinelibrary.wiley.com/doi/book/10.1002/9781119505969)\
