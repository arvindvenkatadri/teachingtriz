...
- For Charts:
  ...
  - Use `gf_facet_***` as appopriate to show small multiple graphs for clarity
...
- For Tables:
  ...
  - Use `df_print: paged` in your YAML header to make nice paged tables for your dataframes
