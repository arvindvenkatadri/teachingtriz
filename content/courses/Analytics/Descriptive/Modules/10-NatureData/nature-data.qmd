...
enterprise. Let us look at the [**slides**](https://r-for-artists.netlify.app/slides/10-nature-of-data/10-nature-of-data).
...
`colour` for each `gender`. `Position` along an axis( x or y) can vary
in accordance with a `bodyWeight` variable.
