...
| Quant         | Quant         | oints/Circles |
| Variable      | Variable      | with Fixed    |
|               |               | Size          |
+---------------+---------------+---------------+
...
| Qual Variable | Qual Variable | with *area*   |
|               |               | proportional  |
|               |               | to joint(X,Y) |
|               |               | *count*       |
+---------------+---------------+---------------+
| Position X =  | Position Y =  | Box +         |
| Qual Variable | Rank-Ordered  | Whisker, Box  |
|               | Quant         | length        |
