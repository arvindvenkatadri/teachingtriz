...
```{r}
ggplot2::theme_set(new = theme_classic(base_size = 12, 
                                       base_family = "sans"))
...
calculated, and so are the `outliers`. A typical box plot looks like this:
...
plot*. Ridge Plots currently have their own package; neither `ggformula`
...
::: callout-note
Questions: Which countries host the maximum number of races? Which
...
::: callout-note
Questions: Which countries have the maximum number of winners (top 3
ranks)?
...
::: callout-note
Question: Which countries have had the most top-3 finishes in the
...
finishes, when it comes to the *longest* races, it is *vive la France*!
:::

::: callout-note
Question: What is the distribution of the finishing times, across all
races and all ranks?
...
::: callout-note
Question: For all races that have a distance around 150, what is the
...
\
See the scrolly animation for a histogram at this website: *Exploring
Histograms, an essay by Aran Lunzer and Amelia McNamara*
