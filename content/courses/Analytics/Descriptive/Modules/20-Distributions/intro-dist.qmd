...
editor: 
  markdown: 
    wrap: 72
webr:
  packages: ['readr', 'dplyr','mosaic', 'skimr', 'ggformula','ggridges', 'palmerpenguins']
...
Here is an interactive app to play with: try to adjust the bin widths / number of bins and see how the histogram changes.
