...
Yet another plot that allows comparison of multiple densities side by side is a **violin plot**. The violin plot combines the aspects of a *boxplot*(ranking of values, median, quantiles...) with a superimposed *density* plot. This allows us to look at medians, means, densities, and quantiles of a *Quant* variable with respect to another *Qual* variable. 
