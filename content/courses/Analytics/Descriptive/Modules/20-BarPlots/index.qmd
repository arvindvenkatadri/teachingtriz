...
|                                                                                                 |                                                                                                    |                                                                                        |
|------------------------|------------------------|------------------------|
| <a href="../../../../../materials/Data/qdd-data.zip"><i class="fa-brands fa-r-project"></i> R (Static Viz)</a>   | <a href="./files/distributions.rda"> <i class="fa-solid fa-person-rays"></i> Radiant Tutorial</a>  | <a href="./files/data/qdd-data.zip"> <i class="fa-solid fa-database"></i> Datasets</a> |
...
##
library(tinyplot) # Fast dependency free charting package
```
...
::: {.column}
```{r}
#| ref.label: research-ggformula-2-1
#| echo: false
```
:::
::::
...
::: {.column}
```{r}
#| ref.label: research-ggformula-2-2
#| echo: false
```
...
::: {.column}
```{r}
#| ref.label: research-ggformula-2-3
#| echo: false
```
...
::: {.column}
```{r}
#| ref.label: research-ggformula-2-4
#| echo: false
```
...
::: {.column}
```{r}
#| ref.label: research-tinyplot-2-1
#| echo: false
```
:::
::::
...
::: {.column}
```{r}
#| label: research-tinyplot-2-2
#| eval: false
tinyplot(~ local | tip, data = taxi_modified,
  type = "barplot",
  beside = FALSE, xlevels = c("no","yes"), # try reversing
  main = "Plot 2A: Stacked Bar Chart",
...
::: {.column}
```{r}
#| ref.label: research-tinyplot-2-2
#| echo: false
```
...
::: {.column}
```{r}
#| label: research-tinyplot-2-3
#| eval: false

## Showing "per capita" percentages

tinyplot(tip ~ local, data = taxi_modified,
        type = "barplot", beside = FALSE,
        FUN = "prop",
        main = "Plot 2C: Filled Bar Chart",
        sub= "Shows Per group differences in Proportions!")
```
...
::: {.column}
```{r}
#| ref.label: research-tinyplot-2-3
#| echo: false
```
...
::: {.column}
```{r}
#| ref.label: research-tinyplot-2-4
#| echo: false
```
...
::: {.column}
```{r}
#| ref.label: research-ggformula-3-1
#| echo: false
```
...
::: {.column}
```{r}
#| ref.label: research-ggformula-3-2
#| echo: false
```
...
:::{.column}
```{r}
#| ref.label: research-ggformula-3-4
#| echo: false
```
