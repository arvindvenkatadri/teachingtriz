...
-   There are several Qualitative variables: `tip`(2), `company`(7) and
    `local`(2), `dow`(7), and `month`(12). These have levels as shown in the parenthesis. 
...
## {{< iconify mdi size-extra-large >}}Bar Plot Extras
...
## {{< iconify openmoji person >}} Are the differences in Proportion Significant?
