...
The problem is that humans are pretty bad at reading angles. This ubiquitous chart is much vilified in the industry and `bar charts` that we have seen earlier, are viewed as better options. However do read this spirited defense of pie charts here.
...
2.  Look at the `whigs` and `highschool` datasets in the package
    `ggraph`. Plot Pies, Fans and if you are feeling confident, Trees, Dendrograms, and Circle Packings as appropriate for these.
