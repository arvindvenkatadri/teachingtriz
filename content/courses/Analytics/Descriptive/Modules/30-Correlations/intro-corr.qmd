...
thematic_rmd(font = "Roboto Condensed",inherit = TRUE,
             bg = "#FFFFFF",fg = "#111111",
             accent = "#DD1144")
...
## {{< iconify ph chart-scatter-bold >}} {{< iconify carbon qq-plot size=4x >}} Scatter Plots
...
movies %>% drop_na() %>%
  ...
  geom_point() + 
  stat_ellipse(level = 0.95, colour = "grey") + 
  stat_ellipse(level = 0.68, colour = "brown") +   
  geom_lm() + 
  labs(title = "Scatter Plot",
       subtitle = "Movie Ratings: Tomatoes vs Audience")
...
#| message: false
# 
# ggplot2::theme_set(theme_bw(base_family = "Roboto Condensed")) + # Works better for ggpairs
