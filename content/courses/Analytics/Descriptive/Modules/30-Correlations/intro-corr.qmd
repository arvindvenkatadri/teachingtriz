...
|                                                                                                   |                                                                                                                   |                                                                                                   |                                                                                       |
|-----------------|---------------------|-----------------|-----------------|
| <a href="./files/correlations.qmd"><i class="fa-brands fa-r-project"></i> R (Static Graphs)</a>   | <a href="./files/correlations-interactive.qmd"> <i class="fa-brands fa-r-project"></i> R (Interactive Graphs</a>  | <a href="./files/correlations.rda"> <i class="fa-solid fa-person-rays"></i> Radiant Tutorial</a>  | <a href="./files/data/qdd-data.zip"> <i class="fa-sold fa-database"></i> Datasets</a> |
