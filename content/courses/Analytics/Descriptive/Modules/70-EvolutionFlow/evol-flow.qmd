---
title: "\U0001F578 Change, Evolution, and Flow"
subtitle: "Change, Evolution, and Flow"
author: "Arvind V."
date: 22/Nov/2022
...
Let us take our prevously loaded `health` dataset and plot just the change in expenditure for multiple countries, across a time span of 8 years (2010 - 2018)
...
# Then plot points
  ...
  gf_point(
    ...
    ylab = "Country",title = "Healthcare Budgets", subtitle = "Changes between 2010 to 2018"
  ) %>% 
...
Note also that the [Bump Charts](/content/courses/Analytics/Descriptive/Modules/80-Ranking/ranking.qmd#bump-charts) are a special case of alluvial/sankey charts where each node connects/flows to one other node.
...
\
Global Migration, <https://download.gsb.bund.de/BIB/global_flow/> A good
...
Other packages: [Sankey plot \| the R Graph Gallery
...
cite_packages(
  ...
  pkgs = c("echarts4r", "ggalluvial", "ggstream", 
           "ggsankey","ggsankeyfier", "networkD3")) %>%
