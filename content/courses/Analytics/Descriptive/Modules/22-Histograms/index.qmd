...
::: callout-note
### Qualitative Data
- `cut`<ord>: Cut of the diamond.(5 levels)
- `color`<ord>: Colour. (7 levels)
...
```
(The `as_flextable` command from the `crosstable` package helpd to render this elegant HTML table we see. It should be possible to do Word/PDF also, which we might see later.)
...
1. Try your hand at these datasets. Look at the data table, state the data dictionary, contemplate a few Research Questions and answer them with graphs in Orange!
