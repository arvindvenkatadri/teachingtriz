...
`diamonds` dataset. We have seen this dataset before in the module on [Descriptive Statistics](../10-FavStats/index.qmd), so we can quickly familiarise ourselves with it. 
