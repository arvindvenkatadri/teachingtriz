...
row is a unique observation or *case*; the reverse, with the **Frequency Form** is rarely possible.
...
data be converted into a ***Contingency Table*** ; the Statistical
tests for Proportions ( the $\chi^2$ test ) also needs Contingency Tables. The *Frequency Table* we encountered earlier is very close to being a
...
So far these packages give Contingency Tables that are **easy to see for humans**; some of these structures are also capable being passed directly
