---
title: <iconify-icon icon="lucide:group" width="1.2em" height="1.2em"></iconify-icon> Boxplots - Plotting Groups 
...
This is a very important idea of *Hypothesis Testing* which helps you justify your hunch. We will study this when we do Stats Tests for [Differences between two means](../../../Inference/Modules/110-TwoMeans/index.qmd), and [those between more than two means](../../../Inference/Modules/130-ThreeMeansOrMore/index.qmd). 
...
- Box plots are ideal for visualizing statistical tests for difference in *mean* values across groups (t-test and ANOVA).
