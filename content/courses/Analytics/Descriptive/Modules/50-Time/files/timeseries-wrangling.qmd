...
As seen before, the `fpp3` packages loads a good few other packages:
...
The tutorial for wrangling using `dplyr` is [here](../../../../../../labs/r-labs/tidy/dplyr.qmd).
:::
...
cite_packages(
  ...
  pkgs = c("fable", "fabletools", "feasts", "fpp3",
           "gapminder", "sweep", "timetk", "tsbox", "tsdl", 
           "tsibble", "tsibbledata", "TSstudio")
) %>%
