...
webr:
  packages: ['readr', 'dplyr','lubridate', 'ggformula','mosaic', 'skimr', 'timetk', 'tsibble', 'tsibbledata','TSstudio','scales']
editor: 
  markdown: 
    wrap: 72
---
...
\
Robert Hyndman, *Forecasting: Principles and Practice (Third Edition)*.
