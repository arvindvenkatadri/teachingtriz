...
`dplyr`-like ability to group and summarize timee series using the
...
deal with these, should you encounter them, is to convert them (Using
[tsbox](https://docs.ropensci.org/tsbox/)) to a `tibble` or a `tsibble`
and work with these.

## {{< iconify flat-color-icons line-chart >}} Time Series Formats, Conversion, and Plotting
...
will do this in the next section. We will do this shortly.
:::
