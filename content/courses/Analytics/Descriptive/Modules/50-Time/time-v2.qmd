...
`tibble` format that we can plot *as is*. We will then look at `tibble`
data that does have a time-oriented variables. We will then perform
...
\
Robert Hyndman, *Forecasting: Principles and Practice (Third Edition)*.[available online](https://otexts.com/fpp3/)\
[Time Series Analysis at Our Coding Club](https://ourcodingclub.github.io/tutorials/time/)\
...
cite_packages(
  ...
  out.dir = ".",
  out.format = "html",
  pkgs = c("fable", "fabletools", "feasts","fpp3",
           "sweep", "timetk","tsbox", "tsdl", "tsibble", "tsibbledata", "TSstudio")
) %>%
