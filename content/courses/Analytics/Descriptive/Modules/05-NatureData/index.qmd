...
# 
#   gf_text(17000 ~ 1.0, 
#           label = "Annotation", color = "orange", 
#           size = 7, fontface = "bold", show.legend = FALSE,
#           inherit = FALSE) %>% 
  
  # Use same name for scales to merge legends
  gf_refine(scale_color_brewer(name = "Plot Legend", 
                               palette = "Set1"),
            scale_shape_manual(name = "Plot Legend", 
                               values = c(15:21)),
...
1.  Adam E.M. Eltorai, Jeffrey A. Bakal, Paige C. Newell, Adena J. Osband (editors). (March 22, 2023) *Translational Surgery: Handbook for Designing and Conducting Clinical and Translational Research*. 
