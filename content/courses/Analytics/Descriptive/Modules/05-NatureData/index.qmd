...
-   Run the entire code by clicking the "Run code" button or pressing
...
3.  Adam E.M. Eltorai, Jeffrey A. Bakal, Paige C. Newell, Adena J. Osband (editors). (March 22, 2023) *Translational Surgery: Handbook for Designing and Conducting Clinical and Translational Research*. 
...
4.  <u><https://safetyculture.com/topics/design-of-experiments/></u>

5.  [Open Intro Stats: Types of
    Variables](https://openintro-ims.netlify.app/data-hello.html#variable-types)

6.  Lock, Lock, Lock, Lock, and Lock. *Statistics: Unlocking the Power
...
7.  Claus Wilke. *Fundamentals of Data Visualization*.
    <https://clauswilke.com/dataviz/>

8.  Tim C. Hesterberg (2015). *What Teachers Should Know About the
