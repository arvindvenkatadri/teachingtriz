...
[**slides**](https://r-for-artists.netlify.app/slides/10-nature-of-data/10-nature-of-data). (Also embedded below!)
...
-   Our [Working
    ...
    abstracts the details and presents us with [an overall summary]{style="background-color: yellow;"}, an
...
![Rape Capital](../../../../../materials/images/rape-capital.png)

![Data Reveals
Crime](../../../../../materials/images/data-reveals-crime.png)
...
[By asking questions!]{style="background-color: yellow;"} Shown below
is a table of different kinds of questions you could use to query a
...
What might be the geometric aesthetics available to us?
 An [aesthetic]{style="background: yellow;"} is a geometric property, such as `x-coordinate`, `y-coordinate`, `length/breadth/height`,`radius`,`shape`,`size`, `linewidth`, `linetype`,  and even `colour`...
...
`colour` for each `gender`. `Position` along an axis x can vary
in accordance with a `height` variable and y with a `bodyWeight` variable.
...
Note that here is also a "natural" mapping between aesthetic and [**kind
of variable**] @sec-data-types, Quantitative or Qualitative. For
instance, `shape` is rarely mapped to a Quantitative variable; we
...
|-------------|-------------|-------------|-----------------------------------|
| Quant      | None       | Histogram and Density                                                                         | {{< iconify ph chart-bar size=4x >}}                                                                                                                                                                                                                                                               |
...
| Qual       | Qual       | Stacked Bar Chart, Mosaic Chart, Sankey, Chord Diagram, Network Diagram                       | {{< iconify iwwa chart-style4 size=4x >}} {{< iconify carbon chart-marimekko size=4x >}} {{< iconify carbon sankey-diagram size=4x >}} {{< iconify carbon network-4 size=4x >}}                                                                                                                    |
|            |            |                                                                                               |                                                                                                                                                                                                                                                                                                    |
...
2.  Lock, Lock, Lock, Lock, and Lock. *Statistics: Unlocking the Power
    of Data*, Third Edition, Wiley, 2021. \<[Statistics: Unlocking the
    Power of Data, 3rd Edition \|
    Wiley](https://www.wiley.com/en-br/Statistics:+Unlocking+the+Power+of+Data,+3rd+Edition-p-9781119674160)\>
3.  [Claus Wilke: Fundamentals of Data
