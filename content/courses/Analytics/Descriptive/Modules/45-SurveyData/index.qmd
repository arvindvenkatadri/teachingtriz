...
knitr::opts_chunk$set(tidy = "formatr", 
                      tidy.opts = list(blank = FALSE, width.cutoff = 30))
library(tidyverse)
...
str(my_survey_data)
##
plot_likert(my_survey_data, values = "sum.inside",
...
`agreement plot`[^1] which captures the agreement between two (sets) of
...
[^1]: Bangdiwala, S.I., Shankar, V. The agreement chart. BMC Med Res Methodol 13, 97 (2013). https://doi.org/10.1186/1471-2288-13-97
