...
![](../../../../../materials/images/rural-survey.jpg)
...
`Very much dislike,` for example. These are then plotted in a chart to get a distribution of opinions for each question in the survey. 
...
#library(sjlabelled
set.seed(42)
score_labels = c("always", "often", "rarely", "never") # numerically 1:5
...
plot_likert(quickez_data, title = "Summary of QuickEZ App Questionnaire",
            #sort.frq = "" # Try "pos.desc" good news on top!
            reverse.colors = TRUE, catcount = 4,
            show.prc.sign = TRUE
            ) 
```
...
- Likert plots are like stacked bar-charts aligned horizontally. They are useful to indicate aspects like opinion, belief, and habits. 
...
1. Jamieson, S. (2004). Likert scales: how to (ab)use them. Medical Education, 38(12), 1217–1218. <doi:10.1111/j.1365-2929.2004.02012.x> 
