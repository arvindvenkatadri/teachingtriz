---
title: "\U0001F554 Modelling and Predicting Time Series"
author: "Arvind V."
date: 19/Nov/2022
...
## {{< iconify gg add >}} {{< iconify mdi multiply-circle-outline >}} Additive and Multiplicative Time Series Models
...
*noise* components are also increasing in a *multiplicative* way here !!
A multiplicative time series can be converted to additive by taking a
...
interval , i.e. zooming in on the time axis. ( i.e. self-similar and
fractal)
