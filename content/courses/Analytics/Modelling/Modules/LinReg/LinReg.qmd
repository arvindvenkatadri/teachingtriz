...
off the predicted median price. That is how the model is used (by hand).
...
examine this `augment`-ed data more in @sec-diagnostics.
...
8. <http://r-statistics.co/Assumptions-of-Linear-Regression.html>
