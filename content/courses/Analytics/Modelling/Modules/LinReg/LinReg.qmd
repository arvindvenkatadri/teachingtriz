...
## {{< iconify icon-park-outline thinking-problem >}} Assumptions in Linear Models
...
all_corrs %>% 
  ...
  gf_refine(scale_colour_distiller("Correlation", type = "div", palette = "RdBu"), scale_linewidth_continuous("Significance",range = c(0.25, 3))) %>% 
...
We may also encounter cases where the predictor variables seem to
...
7.  Schloerke B, Cook D, Larmarange J, Briatte F, Marbach M, Thoen E,
