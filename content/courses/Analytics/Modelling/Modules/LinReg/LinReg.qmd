...
|                                                                                                                                    |                                                                                                                                        |                                                                                                             |     |
|------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------|-----|
| <a href="./files/forward-selection.qmd"><i class="fa-brands        fa-r-project"></i>Multiple Regression - Forward Selection</a>   | <a href="./files/backward-selection-2.qmd"><i class="fa-brands        fa-r-project"></i>Multiple Regression - Backward Selection</a>   | <a href="./files/lin-perm.qmd"> <i class="fa-brands fa-r-project"></i> Permutation Test for Regression</a>  |     |
