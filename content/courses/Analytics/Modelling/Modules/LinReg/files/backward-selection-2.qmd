...
There are a good many predictors which have significant correlations
with `Salary`.
...
We ought to convert the code into a function and run it that way for a
specific number of rounds to see how things pan out. That is in the next
