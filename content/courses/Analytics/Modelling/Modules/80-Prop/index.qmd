...
gss_table %>% addmargins() %>% kableExtra::kable()
...
gss_exp %>% addmargins() %>% kableExtra::kable(digits = 0,label = "Expected")
gss_table %>% addmargins() %>% kableExtra::kable(digits = 0,label = "Actual")
