...
collapsed into a **SINGLE** matrix multiplication of the coordinates of
the shape.

See this webpage at Mathigon to get an idea of [**rigid transformations
of
shape.**](https://mathigon.org/course/transformations/rigid#transformations)
...
cite_packages(
  ...
  out.dir = ".",
  out.format = "html",
  pkgs = c("ambient", "matlib","mosaicCalc", "plot3D")
) %>%
