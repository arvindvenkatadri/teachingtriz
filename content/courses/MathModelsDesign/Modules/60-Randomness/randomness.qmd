...
{{< video "https://vimeo.com/150216437" >}}
...
![Photo by "Sharath G."Viewers" from
Pexels](pexels-viewers-16179014.jpg)
...
{{< video "https://www.youtube.com/watch?v=qan0Y9hXpPQ" >}}
...
p2 <-
  ggplot(scores, aes(x = p1, y = scores, fill = test), colour = "black") +
...
> times, say five thousand, to get the *permutation distribution* shown
> in @fig-Perm-Test-2.

```{r echo=FALSE, warning=FALSE, message=FALSE}
#| label: fig-Perm-Test-1
#| fig-cap: 
#|   - "One Shuffled World"
#|   - "Permutation Test Worlds"
...
null_dist_time %>% 
  ...
  labs(x = "Difference in Ad Times", 
       y = "How Often did that happen?",
       title = "Distribution of Simulated Differences in Ad Times",
       subtitle = "Alternative Worlds from a Permutation Test",
       caption = "Is 2.34 possible by Chance?") + 
...
### Fun Stuff: *Words B'long Hamlet*

[Hamlet's *To be or not to be* in Pidgin English - Video on Twitter!](https://twitter.com/bbcnewspidgin/status/1108724221784530945?ref_src=twsrc%5Etfw%7Ctwcamp%5Etweetembed%7Ctwterm%5E1108724221784530945%7Ctwgr%5Ee0657980c128bdf797a7c69d5b3748da6f96377a%7Ctwcon%5Es1_c10&ref_url=http%3A%2F%2Flocalhost%3A4200%2Fcontent%2Fcourses%2FMathModelsDesign%2FModules%2F60-Randomness%2Frandomness.html%3Fcapabilities%3D1host%3Dhttp3A2F2F127.0.0.13A30781)

Want to recite it yourself? Here you go: To be or Not to be, in [Tok
Pisin](https://www.hawaii.edu/satocenter/langnet/definitions/tokpisin.html):

> Which way this time? Me killem de finish body b'long me.\ 
...
> Bimeby him fall down die finish?\
> Me no savvy.
