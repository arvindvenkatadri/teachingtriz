...
1. [The Perceptron](../20-Perceptron/index.qmd)
1. [The Multilayer Perceptron](../30-MLP/index.qmd)
1. [Backpropagation](../40-BackProp/index.qmd)
1. [Gradient Descent](../50-GradientDescent/index.qmd)
1. [Convolutional Neural Nets](../60-Convnet/index.qmd)
