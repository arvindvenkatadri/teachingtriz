...
```{d2}
title: Error Backpropagated from e21 {
  shape: text
  near: top-center
  style: {
    font-size: 60
...
$$
\begin{align}
e_{11} ~~\pmb\sim~~ ~ e_{21} * \frac{W_{11}}{Sum~of~Weights~to~{\color{magenta}{\pmb{h_1}}}}\\
e_{12} ~~\pmb\sim~~ ~ e_{21} * \frac{W_{12}}{Sum~of~Weights~to~{\color{magenta}{\pmb{h_1}}}} \\
e_{13}~~\pmb\sim~~ ~ e_{21} * \frac{W_{13}}{Sum~of~Weights~to~\color{magenta}{\pmb{h_1}}} \\
\end{align}
$$
:::
::: {.column width=4%}
...
$$
\begin{align}
e_{11} ~~\pmb\sim~~ ~ e_{21} * \frac{W_{11}}{\pmb{\color{magenta}{W_{11} + W_{12} + W_{13}}}}\\
e_{12} ~~\pmb\sim~~ ~ e_{21} *\frac{W_{12}}{\pmb{\color{magenta}{W_{11} + W_{12} + W_{13}}}} \\
e_{13} ~~\pmb\sim~~ ~ e_{21} *\frac{W_{13}}{\pmb{\color{magenta}{W_{11} + W_{12} + W_{13}}}}  \\
\end{align}
$$
:::
::::
...
$$
\begin{align}
e_{11} =~ e_{21} * \frac{W_{11}}{Sum~of~weights~to~{\color{orange}{\pmb {h_1}}}}\\
+ ~ e_{22} * \frac{W_{21}}{Sum~of~Weights~to~\color{pink}{\pmb{h_2}}} \\
+ ~ e_{23} * \frac{W_{31}}{Sum~of~Weights~to~\color{teal}{\pmb{h_3}}}  \\
\end{align}
$$
:::
::: {.column width=4%}
...
+ e_{22} * \frac{W_{21}}{\pmb{\color{pink}{W_{21} + W_{22} + W_{23}}}} \\
