...
How to understand this monster equation intuitively? Let us draw a diagram to visualize the components:

```{d2}
title: Gradient Interpreted {
  shape: text
  near: top-center
  style: {
    font-size: 60
...
$$
W^l_{jk}~|~new = W^l_{jk}~|~old - \delta * gradient
$${#eq-Wljk-adaptation}

and we adapt all weights in opposition to their individual cost gradient. 
