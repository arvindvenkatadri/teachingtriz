---
title: <iconify-icon icon="ph:circles-three-fill" width="1.2em" height="1.2em"></iconify-icon> <iconify-icon icon="gravity-ui:function" width="1.2em" height="1.2em"></iconify-icon> Going Round in Circles
subtitle: ""
...
Sums of Complex exponentials are very common in mathematics and show up in many places: here, with symmetry, with [Fourier Series](../15-FourierSeries/index.qmd), with Sound synthesis and Analysis.
