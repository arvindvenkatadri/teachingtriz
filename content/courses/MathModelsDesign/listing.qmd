...
Design. The algorithms will be examined and then coded in `R` and/or
`p5.js`; however other open source tools (FOSS) may also be introduced
as and when needed.

This course stands on "three legs": Maths, Code + Tech, and Artifacts,
as shown below. As this course grows and hopefully becomes popular ;-D,
more and more of these modules below will become reality!
...
|                    |                    | -   Kolams         |
| -   Complex        | -   Shapes         |                    |
|     Numbers        |                    | -   Angolan Sona   |
|                    | -   Stack, Push    |     Patterns       |
| -   Random Numbers |     and Pull,      |                    |
|                    |     Translate      | -   L-Systems      |
| -   Vector Algebra |                    |                    |
|                    | -   Vectors        | -   Symmetries     |
| -   Fourier Series |                    |                    |
...
|                    |     and OOP        |                    |
+--------------------+--------------------+--------------------+
| -   Electrical     | -   Adding         | -   Sound          |
|     System Theory  |     External       |                    |
|     (poles /       |     Libraries      | -   Video          |
|     zeroes /       |                    |                    |
|     resonance...)? | -   Camera, Sound  | -   Text           |
|                    |     and Mic        |                    |
| -   DSP basics?    |                    | -   Crowd-Sourced  |
|                    | -   Handphone      |     acts ( jam     |
| -   AM/FM/PM       |     based          |     session /      |
|     Modulation?    |     Interactions   |     flash-techno   |
|                    |                    |     mob..)?        |
| -   Bessel         | -   OSP Protocol   |                    |
|     Functions?     |     based          | -   Mouse /        |
|                    |     interactions   |     Touchpad       |
| -   Waves / Echoes |     with external  |     Orchestra?     |
|     ?              |     hardware over  |                    |
|                    |     WiFi / BT      |                    |
| -   Nonlinearities |                    |                    |
|     / Saturation / |                    |                    |
...
+--------------------+--------------------+--------------------+
| -                  | -   ml5.js         | -   Multi-Layer    |
|    Classification, |     libraries      |     Perceptrons    |
|     Regression     |                    |                    |
|                    |                    | -   Convolutional  |
| -   Matrix Algebra |                    |     Neural         |
|                    |                    |     Networks       |
| -   Training and   |                    |                    |
|                    |                    | -   Pose, Gesture, |
...
|     Phenomena?     |     Makey-Makey /  |                    |
|                    |     Arduino /      | -   Games?         |
| -   "Literary"     |     Raspberry Pi?  |                    |
|     Events with    |                    | -   Public Space   |
|     Tech?          | -   Sensors?       |     Installations? |
|                    |                    |                    |
|                    | -   Working with   | -   Simulations?   |
|                    |     other          |                    |
|                    |     materials like | -   Remote         |
|                    |     sand, water,   |     Education with |
|                    |     paper, wood,   |     Gesture        |
|                    |     cloth,         |     tracking and   |
...
2.  p5.js Wiki. <https://github.com/processing/p5.js/wiki>

3.  <https://www.codecademy.com/learn/learn-p5js>

4.  <https://www.codecademy.com/courses/learn-p5js/articles/p5js-creating-a-local-project>

5.  <https://openprocessing.org>

6.  <https://happycoding.io/tutorials/p5js/>

7.  <https://www.codecademy.com/content-items/5e5c0d2a7b20535fbe8aed05e739e027>

8.  Rune Madsen. *Programming Design Systems*.
...
1. Michael Nielsen. <http://neuralnetworksanddeeplearning.com/index.html>
1. 
