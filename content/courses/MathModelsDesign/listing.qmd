...
subtitle: "Using matters of ~~Life and Death~~ Math and  Code to Create Novel Experiences"
date: '2022-12-31'
abstract: ""
image: "preview.jpeg"
...
needed and as and when I learn and get excited about them.
...
| Linear Systems <br> Impulse Responses<br>Convolution<br>Electrical System Theory (poles; zeroes; resonance…)?<br>DSP basics?<br>AM/FM/PM Modulation?<br>Fourier Series<br>Bessel Functions? Waves; Echoes ?<br>Non-linearities; Saturation; Hysteresis ? | Adding External Physics and Sound Libraries<br>`p5.sound`<br>Camera, Sound and Mic<br>Handphone based Interactions<br>OSP Protocol based interactions with external hardware over WiFi / BT | Sound<br>Video<br>Text<br>Crowd-Sourced acts (jam session; flash-techno mob…)?<br>Mouse - Touchpad Orchestra? |
| Neural Net Basics <br>Matrix Algebra<br>Training<br>Backpropagation<br>Gradient Descent<br>Classification, Regression, Clustering | <br>`ml5.js` libraries | Multi-Layer Perceptrons<br>Convolutional Neural Networks<br>Pose, Gesture, and Face Detection |
| Complexity and Emergent Phenomena? | Interfacing `p5.js` with Makey-Makey / Arduino / Raspberry Pi?<br>Sensors?<br>Working with other materials like sand, water, paper, wood, cloth, balloons ?<br>“Action at a Distance” using say ~~quantum~~ ~~entanglement~~ [IFTTT](https://ifttt.com)? | Friendship Networks? <br>Games?<br>Public Space Installations<br>Simulations<br>Remote Education with Gesture tracking and live Coding?<br>“Literary” Events with Tech? |
| I’ll | Be | Back |
...
3.  Rune Madsen. *Programming Design Systems*.
    ...
    design.
4.  Colah's ( not ~~Kolha's~~ 🦊 ) Blog.
    [https://colah.github.io/https://colah.github.io/](https://colah.github.io/)
...
6.  François Fleuret. *The Little Book of Deep Learning*.
    <https://fleuret.org/public/lbdl.pdf>
7.  Frank Rosenblatt. *Principles of Neurodynamics: Perceptrons and the
    Theory of Brain Mechanisms*.
    <https://gwern.net/doc/ai/nn/1962-rosenblatt-principlesofneurodynamics.pdf>
8.  Warren S. McCulloch, Walter Pitts (1943). *A Logical Calculus of the
    Ideas of Immanent in Nervous Activity*. BULLETIN OF MATHEMATICAL
    BIOPHYSICS VOLUME 5, 1943.
    \<[https://www.aemea.org/math/McCulloch_Pitts_1943.pdfhttps://www.aemea.org/math/McCulloch_Pitts_1943.pdf](https://www.aemea.org/math/McCulloch_Pitts_1943.pdf)
...
10. Sophia Crespo: (makes speculative biological creatures using neural
    ...
    -   Github:
11. R for Scientific Visualization.
    <https://www.rforscience.com/visualisation.html>
12. R for Scientific Computing.
...
3.  Tim Cortina at Carnegie Mellon Univ2.
    <https://www.cs.cmu.edu/~tcortina/15104-f20/lectures/>
