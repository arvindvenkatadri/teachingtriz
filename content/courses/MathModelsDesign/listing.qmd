...
| -   Convolution     | -   `p5.sound`  |     session;        |
| -   DSP basics?     | -   Camera,     |     flash-techno    |
| -   AM/FM/PM        |     Sound and   |     mob...)?        |
|     Modulation?     |     Mic         | -   Mouse -         |
| -   Bessel          | -   Handphone   |     Touchpad        |
|     Functions?      |     based       |     Orchestra?      |
| -   Waves; Echoes ? |                 |                     |
| -                   |    Interactions |                     |
|    Non-linearities; | -   OSP         |                     |
|     Saturation;     |     Protocol    |                     |
...
| -   Backpropagation |                 | -   Pose, Gesture,  |
| -   Classification, |                 |     and Face        |
...
|     Events with     |     Raspberry   |     Installations   |
|     Tech?           |     Pi?         | -   Simulations     |
|                     | -   Sensors?    | -   Remote          |
|                     | -   Working     |     Education with  |
|                     |     with other  |     Gesture         |
|                     |     materials   |     tracking and    |
|                     |     like sand,  |     live Coding?    |
|                     |     water,      |                     |
|                     |     paper,      |                     |
|                     |     wood,       |                     |
|                     |     cloth,      |                     |
