...
|                      |                      | -   Angolan Sona     |
| -   Random Numbers   | -   Stack, Push and  |     Patterns         |
|                      |     Pull, Translate  |                      |
| -   Vector Algebra   |                      | -   L-Systems        |
|                      | -   Vectors          |                      |
...
|                      |     OOP              |                      |
+----------------------+----------------------+----------------------+
| -   Electrical       | -   Adding External  | -   Sound            |
|     System Theory    |     Libraries        |                      |
|     (poles / zeroes  |                      | -   Video            |
|     / resonance...)? | -   Camera, Sound    |                      |
|                      |     and Mic          | -   Text             |
| -   DSP basics?      |                      |                      |
|                      | -   Handphone based  | -   Crowd-Sourced    |
| -   AM/FM/PM         |     Interactions     |     acts ( jam       |
|     Modulation?      |                      |     session /        |
|                      | -   OSP Protocol     |     flash-techno     |
| -   Bessel           |     based            |     mob..)?          |
|     Functions?       |     interactions     |                      |
|                      |     with external    | -   Mouse / Touchpad |
| -   Waves / Echoes ? |     hardware over    |     Orchestra?       |
|                      |     WiFi / BT        |                      |
| -   Nonlinearities / |                      |                      |
|     Saturation /     |                      |                      |
|     Hysteresis?      |                      |                      |
+----------------------+----------------------+----------------------+
| -   Classification,  | -   ml5.js libraries | -   Multi-Layer      |
|     Regression       |                      |     Perceptrons      |
|                      |                      |                      |
...
|                      |     Raspberry Pi?    | -   Games?           |
| -   "Literary"       |                      |                      |
|     Events with      | -   Sensors?         | -   Public Space     |
|     Tech?            |                      |     Installations?   |
|                      | -   Working with     |                      |
|                      |     other materials  | -   Simulations?     |
|                      |     like sand,       |                      |
|                      |     water, paper,    | -   Remote Education |
|                      |     wood, cloth,     |     with Gesture     |
|                      |     balloons ?       |     tracking and     |
|                      |                      |     live Coding?     |
|                      | -   "Action at a     |                      |
|                      |     Distance" using  |                      |
|                      |     say IFTTT?       |                      |
