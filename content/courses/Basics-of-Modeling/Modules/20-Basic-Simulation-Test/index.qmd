...
1.  R. A. Fisher, *The Design of Experiments*,
    <https://home.iitk.ac.in/~shalab/anova/DOE-RAF.pdf>

2.  Allen Downey, *There is Still Only One Test*,
...
4.  Daniel Kaplan, *Statistical Modelling*, Available free on the web.
    <https://dtkaplan.github.io/SM2-bookdown/>

5.  Russell A. Poldrack, *Statistical Thinking for the 21st Century*.
    Available free on the web.
    <https://statsthinking21.github.io/statsthinking21-core-site/>

6.  Mine Çetinkaya-Rundel & Johanna Hardin, *An Introduction to Modern
    Statistics*, Available free on the web.
    <https://www.openintro.org/book/ims/>.

7.  *Start Teaching Stats with R*, by the Mosaic Project. All about the
    `mosaic` package in R. Available free on the web.
    <https://github.com/ProjectMOSAIC/LittleBooks/raw/master/Starting/MOSAIC-StartTeaching.pdf>

8.  D. Salsburg. *The Lady Tasting Tea: How statistics revolutionized
    science in the twentieth century.* W.H. Freeman, New York, 2001

9.  <https://timesofindia.indiatimes.com/sports/cricket/icc-mens-t20-world-cup/in-numbers-virat-kohli-and-his-strange-luck-with-the-coin-toss/articleshow/87538443.cms>
