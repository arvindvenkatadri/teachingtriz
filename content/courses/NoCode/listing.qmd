...
This Unit takes SMI ~~peasants~~ students on a journey of using data to tell stories and make decisions, and maybe startle a few people. Without ~~doing an iota of work~~ writing one byte of code. Bah. 
...
1. **Observable Plot**: <https://observablehq.com/plot/> The JavaScript library for exploratory data visualization that can create expressive charts with concise (Javascript) code.
