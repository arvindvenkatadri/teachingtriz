...
1. Insurance Data {{< downloadthis data/insurance.csv dname="insurance" label="Download the Insurance data" icon="database-fill-down" type="info" >}}


2. Political Donations {{< downloadthis data/donations.csv dname="donations" label="Download the Donations data" icon="database-fill-down" type="info" >}}
...
What story can you tell, and deduction can you make from @fig-ai-detectors-are-biased ? How would you [replicate it](https://www.rawgraphs.io/learning/how-to-make-a-violin-plot)? What would you add?
