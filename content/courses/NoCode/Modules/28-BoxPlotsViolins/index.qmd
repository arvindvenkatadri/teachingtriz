...
In the @fig-boxplot-density, the boxplot is the one on the top. The *box* part represents the **middle 50%** of the data, in order of magnitude, and the two halves of the box are defined by the *nedian line*. 
...
This is a very important idea of *Hypothesis Testing* which helps you justify your hunch. Try to do this for the [Package Opening and Closing Times](../20-Histograms/index.qmd#your-turn). 
