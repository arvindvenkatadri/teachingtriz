...
We saw with [Bar Charts](../22-BarCharts/index.qmd) that when we deal with single Qual variables, we perform *counts* for each *level* of the variable. What is there are two Quals? Or even more?
