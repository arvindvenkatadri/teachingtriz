...
1. Horror Movies ( oh, you awful people..)
...
- If so, then if one is the [target variable](https://orangedatamining.com/blog/machine-learning-jargon/) you are trying to **design for**, then the other [independent, or controllable, variable](https://www.scribbr.com/methodology/independent-and-dependent-variables/) is something you might want to **design with**. 
