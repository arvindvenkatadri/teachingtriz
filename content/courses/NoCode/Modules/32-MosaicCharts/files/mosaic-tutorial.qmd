...
```{r}
#| label: Hospital-Association-Plot
...
```{r}
#| label: Hospital-mosaic-Friendly
...
```{r}
#| label: Hospital-association-Friendly
...
```{r}
#| label: Arthritis-Mosaic-chi-squared-1
...
```{r}
#| label: Arthritis-Mosaic-chi-squared-2
set.seed(myseed)
