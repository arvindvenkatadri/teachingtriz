...
So why do we need to summarise data? Summarization is an act of *throwing away data to make more sense*, as stated by [@stigler2016]. To summarize is to understand. Add to that the fact that our [Working Memories can hold maybe 7 items](https://www.wikiwand.com/en/The_Magical_Number_Seven,_Plus_or_Minus_Two).
