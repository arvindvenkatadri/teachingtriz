...
Play with the summary output settings, and also with choosing which variable to `Group By`.
...
![](../../../../materials/images/Orange/penguins-species-sex-group.png){#fig-group-species-sex}
