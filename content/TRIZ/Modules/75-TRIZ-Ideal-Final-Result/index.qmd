...
# Measurement
causes[1] <- list(c("Engines are On", "", "RMS Carpathia:\n4 hours", "", "4 Minutes to Die\nin the Water", "", "Titanic will sink\n in 2 hours", "Tilting from the Front"))

# Material
causes[2] <- list(c("Furniture", "Food", "Clothes", "Sea Water", "Ice", "Cargo", "Food/Water in the LifeBoats"))
...
1. Darell Mann. (01)-March-2020)*The Operationally Efficient Sinking of the Titanic.*. TRIZ Journal. <https://the-trizjournal.com/the-operationally-excellent-sinking-of-the-titanic/>
