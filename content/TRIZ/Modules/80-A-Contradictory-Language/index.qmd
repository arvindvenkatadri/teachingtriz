...
["Mathematics is the art of giving the same name to different things."]{.f5 .f4-m .f3-l .lh-copy .measure .mt0}

[ --- Henri Poincaré (1854–1912),French mathematician, theoretical physicist, engineer, and philosopher of science, ]{.f6 .ttu .tracked .fs-normal}
:::
::::
...
## An Interdisciplinary Esperanto

So: let us use a metaphor for a metaphoric language !!

::: {#fig-esperanto }
<br>
{{< video https://www.youtube.com/watch?v=whGSkjXTPjU align="center" width="560" height="400" >}}
...
The creator of TRIZ, **Genrich Altshuller**, was born in Russia in 1926, made his first invention at age 14 (9th Grade), and was later educated as a mechanical engineer. At the time he started working on TRIZ, in 1946, he was employed in the Patents Department of the Soviet navy, assisting inventors in filing their patents, in Baku, Azerbaijan.  
...
```{r}
#| label: fig-invention-levels
#| fig-cap: "Altshuller's Classification: Soviet Inventions and their Innovation Levels"
#| echo: false
#| fig.align: 'center'
#| out.height: "300px"
#| out.width: "480px"
...
[Levels #2 & #3 solve contradictions and therefore are innovative by definition.]{style="background-color:yellow;"}.
...
- TRIZ Parameters: `2(Weight of an stationary Object)`, `21(Loss of Substance)`, and `22(Temperature)`.  
- TRIZ Inventive Principles: `4(Asymmetry)`, `35(Parameter Change)` and `13(The Other Way Around)`. 
...
## Some Technical Contradiction Examples

*TC Examples*:  

A. Aircraft Engines

- To increase the speed of an airplane, a new and more powerful engine is installed. This increases the weight of the airplane so the wings can no longer support it during takeoff. Increasing the wing size produces more drag, slowing the airplane down. In TRIZ language, we might choose the following pair out of the 48 Parameters:

  - `15(Force / Torque)` vs `1(Weight of Moving Object)`

B. Formula#1: Pitstops
...
::: {#fig-pitstop-time align="center" width="560" height="400"}

{{< video https://youtu.be/vlUUrrwcUQw align="center" width="560" height="400" >}}

Formula #1 Pitstops: Time versus Stablity

:::

<br>

So we need nuts to retain the wheel, but we don't want to lose time unscrewing them at pit-stops. In TRIZ language, we might express this as a a TC by:

- `21(Stability)` vs `26(Loss of Time)`
...
::: {#fig-einstein align="center" width="560" height="400"}

{{< video https://youtu.be/iEtQ-gQ0Bq8 align="center" width="560" height="400" >}}
...
- TRIZ gives us a **unifying** metaphoric language.
- The language allows us two grand facilities: to **describe** our problems; and to **obtain** solutions for them
- The words and phrases are metaphors, so we need to be aware of their power to mean different things at different times and places, just as Poincare said above. 
- So in effect, each of our Problems is telling TRIZ to *Call me by Your Name*!!

## {{< iconify fluent-mdl2 decision-solid >}} Conclusion

- We learn to make metaphors out of our problems Contradictions
- TRIZ returns the compliment by giving us metaphoric Solutions in return!
- We unwrap these gifts and bring them back to earth, into the domain of our Problem
- And we will know, and solve, our Problem for the first time, as T.S. Eliot said. 
