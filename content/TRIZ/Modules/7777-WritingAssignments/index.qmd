...
subtitle: "The Thirteen Tasks of Hercules"
date: "2025-11-30"
...
Ref: [I am Water](../../../Basics/Modules/10-Flow-and-Play/index.qmd):
...
Ref: [I yam What I yam](../../../Basics/Modules/20-Cultural-Capital/index.qmd):
...
Ref: [Bird of Different Feathers](../../../Basics/Modules/30-MBTI-Big-5/index.qmd):

- (May be too much for illiterate SMI Peasants). But let's try:
- Watch any biopic: Linked here are two examples:  
   - **The Theory of Everything** ( about Stephen Hawking) [(Trailer)](https://www.youtube.com/watch?v=Salz7uGp72c)  
   - **A Beautiful Mind** ( about John Nash) [(Trailer)](https://www.youtube.com/watch?v=aS_d0Ayjw4o)
...
### Assignment-4. Do Adjectives follow Abstract Nouns on Social Media?

Ref: [I Connect therefore I am](../../../Basics/Modules/40-Domain-Field-Self/index.qmd):
...
Ref: [Thinking Fast and Slow](../../../Basics/Modules/50-Thinking-Fast-Slow/index.qmd):

- To be Written Up. Need to think of something suitable for peasants.

### Assignment-6. TBD

Ref: [The Art of Parallel Thinking](../../../Basics/Modules/60-Parallel-Thinking/index.qmd):

- To be Written Up. Need to think of something suitable for peasants.

### Assignment-7. Why is a Raven like a Writing Desk?
Ref: [A Year of Metaphoric Thinking](../../../Basics/Modules/70-Metaphoric-Thinking/index.qmd)
...
### Assignment-8. A-social Media

Ref: [Problems and Contradictions](../60-Problems-and-Contradictions/index.qmd)
   ...
   - Find **3 posts** or stories that are especially funny or startling, or have people up in arms
   ...
   - [`Less than 3`](https://www.reddit.com/r/criticalrole/comments/6icuva/no_spoilers_origin_of_less_than_three/?rdt=61440) to you if you can create a meme that becomes viral in class, including with your (elderly) Teaching Faculty.
   
### Assignment-9. Count your Blessings

Ref: [TRIZ Resources](../70-TRIZ-Resources/index.qmd):
...
Ref: [Ideal Final Result (IFR)](../75-TRIZ-Ideal-Final-Result/index.qmd)
...
Refs: [A Contradictory Language](../80-A-Contradictory-Language/index.qmd) and [The Contradiction Matrix Workflow](../90-TRIZ-Contradiction-Matrix/index.qmd)
   ...
   - Write the `TECHNICAL CONTRADICTION (TC)` that might have been solved using the `IP` mentioned. ("reverse TRIZ")
   ...
   - Write the `ADMINISTRATIVE CONTRADICTION (AC)` that might have come before the `TC`. ( You could work these in any order, as your intuition works.)
   - This website from Ron Aharoni ( whose PhD was on TRIZ ) is a very useful one to complete this reverse procedure. On this page, clicking on each Inventive Principle, will give you a list of possible Contradictions where this IP surfaces. (Note: this still uses the Old TRIZ Matrix, not the latest 2003 Darrell Mann version. Ummm...) <https://www.triz40.com/aff_Principles_TRIZ.php> 
