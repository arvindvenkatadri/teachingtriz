...
causes[1] <- list(c("Loud Noises", "Boring Talk", "Time Spent", "Obnoxious Smells", "Distance to Drive"))
...
ss.ceDiag(effect,causes.head,causes, main ="Me, Mom, and the Market",#ss.col = c("", "red"), 
          sub = "Ishikawa Cause-Effect Diagram for Boredom\ made with R packages SixSigma and qcc")
...
The YM wants to chill at home but Mom wants him to
...
:::callout-note
## Ideal Final Result
The YM must go to the Market and not be bored.
:::
...
::: callout-note
## TC 1
Improve `Loss of Time` (26) and not worsen `Effect of External Harmful Factors` (30)
:::

::: callout-note
## TC 2
Improve `Increase Productivity` (44) and not worsen `Stress` (19)
:::
...
The YM must be in the market and not be in the market at the same time.
:::
...
#| out-height: "120%"
#| fig-align: center
#| fig-cap: "TRIZ Matrix for TC1 and TC2"
knitr::include_graphics("matrix.png")

```

The two squares for the TC1 have been circled in red, solving TC-1. The Inventive Principles are:(TC1, TC2, both ways)
...
played on Spotify becomes not just a [*noise canceller*](https://www.ti.com/lit/an/spra337/spra337.pdf) but actually
...
::: callout-note
## IFR2
The veggies should arrive without (the YM) going to the Market
:::

::: callout-note
## IFR3
Food should be prepared without having to go buy veggies.
:::
...
could well be the [**Voice of (another) Customer**](https://www.mit.edu/~hauser/Papers/Gaskin_Griffin_Hauser_et_al%20VOC%20Encyclopedia%202011.pdf).
