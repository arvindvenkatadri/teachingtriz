...
We will look at the *48 TRIZ Parameters* in the [*TRIZ Contradiction Matrix* **(PDF)**](../../materials/ContradictionMatrix2003.pdf) and see which
Parameter we want to improve, while not worsening another. Here is what
we can attempt, stating the Contradiction both ways[^2]:
...
-   **IP 13: The Other Way Around**. How? Not attack by sea?
    Wait...**ATTACK BY LAND**!! Change the **DIRECTION** of Attack! So
    attack from the other side, the land side!! (We could
...
-   **IP 35: Parameter Change**. But "ships" on land?? Note, *the desert
    ...
    **Resources** in the problem, as we have duly noted in the Ishikawa
    ...
    Ships of the Desert*!! Parameter Change.
